...
public class CheckScoreList implements Serializable {
    ...
    public static boolean delete(String id){
        for (Score score : StudentScoreManage.scoreList) {
            ...
            if (studentId.equals(id) || courseId.equals(id)){
                StudentScoreManage.scoreList.remove(score);
                Input.scoreList(StudentScoreManage.scoreList);
                return true;
            }
        }
        return false;
     ...
     * 保存
     */
    public static void polish(String oldId,String newId){
        for (Score score : StudentScoreManage.scoreList) {
            String studentId = score.getStudentId();
            String courseId = score.getCourseId();
            if (studentId.equals(oldId)){
                score.setStudentId(newId);
                //集合--文件
                Input.scoreList(StudentScoreManage.scoreList);

            }
            else if (courseId.equals(oldId)) {
                score.setCourseId(newId);
                Input.scoreList(StudentScoreManage.scoreList);
            }
        }
    }
